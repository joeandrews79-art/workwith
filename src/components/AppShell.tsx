...
function Icon({ name }: { name: IconKey }) {
  ...
  switch (name) {
    ...
    case "teammap":
      return <svg {...common}><path d="M3 3v18h18" /><circle cx="8" cy="15" r="1.6" /><circle cx="13" cy="9" r="1.6" /><circle cx="18" cy="12" r="1.6" /></svg>;
    case "meeting":
...
const BASE: { href: string; label: string; icon: IconKey }[] = [
  ...
  { href: "/team-map", label: "Team map", icon: "teammap" },
